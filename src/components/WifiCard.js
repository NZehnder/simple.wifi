...
import HIS_logo from '../../src/images/HIS_Logo.svg';
import './style.css';
...
export const WifiCard = (props) => {
  ...
  return (
    <Pane>
      ...
      >
        <Pane display="flex" paddingBottom={12} justifyContent='space-between'>
          ...
          <Heading
            ...
            paddingLeft={10}
          >
            <Link href="https://www.headitsolutions.ch/"><img alt="icon" src={HIS_logo} width="90.44" height="32" /></Link>
          </Heading>
        </Pane>
